# -*- coding:utf-8 -*-
"""
This is pulled directly from the DFRobot repository. Source:
https://github.com/DFRobot/DFRobot_RaspberryPi_Motor/blob/master/DFRobot_RaspberryPi_DC_Motor.py
"""
...
class DFRobot_DC_Motor:
    ...
    def set_encoder_reduction_ratio(self, id, reduction_ratio):
        ...
        if reduction_ratio < 1 or reduction_ratio > 2000:
            ...
            return
        for i in self._parse_id(id):
            self._write_bytes(self._REG_ENCODER1_REDUCTION_RATIO + 5 *
                              (i - 1), [reduction_ratio >> 8, reduction_ratio & 0xff])
